...
urlpatterns = [#url(r'^search-form/$', views.search_form),
    ...
    url(r'^patient_bpmeasure/([0-9]+)$', views.PatientBPMeasure.as_view(), name = 'patient-bpmeasures'),
    url(r'^bpmeasure_add/(?P<fk>[0-9]+)$', views.PatientBPMeasureCreate.as_view(), name = 'bpmeasure-add'),
