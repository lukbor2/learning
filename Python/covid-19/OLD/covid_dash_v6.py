...
def make_graph(country_1, country_2, region_1, region_2, view, delta_p):
    measure_1 = view
    ...
    fig.update_layout(xaxis_tickangle=-45, showlegend=False, height=1200, yaxis2_tickformat=y_axixs, yaxis4_tickformat=y_axixs)
