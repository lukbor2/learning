...
def set_region_list(country_1, country_2):
    ...
    ds_regions_1 = ds_regions_1.append({'final_01_region': '""'}, ignore_index=True) #I have to appen this value because it selects the entire country.
    ds_regions_2 = pd.read_sql(qry_2, con=db_connection)
    ds_regions_2 = ds_regions_2.append({'final_01_region': '""'}, ignore_index=True) #I have to appen this value because it selects the entire country.
