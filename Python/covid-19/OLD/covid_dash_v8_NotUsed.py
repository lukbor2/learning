...
#In this version I tried 2 traces on the same chart but I did not like it.
...
def make_graph(country_1, country_2, region_1, region_2, view, delta_p, since_100):
    ...
    if delta_p:
        ...
        fig.add_trace(
            go.Scatter(
                x = ds_country_1["final_01_date"],
                y = ds_country_1[measure_2].rolling(7).mean(),
                marker_color = '#19D3F3',
    ...
    if delta_p:
        ...
        fig.add_trace(
            go.Scatter(
                x = ds_country_2["final_01_date"],
                y = ds_country_2[measure_2].rolling(7).mean(),
                marker_color = '#19D3F3',
                name="Last 7 Days Avg",
            ),
            row=4, col=1,
    ...
    #fig.update_layout(xaxis_tickangle=-45, legend_orientation="h", height=1200, yaxis2_tickformat=y_axixs, yaxis4_tickformat=y_axixs)
    fig.update_layout(xaxis_tickangle=-45, showlegend=False, height=1200, yaxis3_tickformat=y_axixs, yaxis5_tickformat=y_axixs)
